			...
			<div class="row align-items-center">
				<div class="col-md-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#">Trustee Fee Rule Update</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-12 col-xl-6">
							<div class="card">
								...
								<div class="card-block">
									<form id="trf_form" action=" {{ url('parameters-setup/trstfeerule/update') }} " method="post">

										@csrf

										<input type="hidden" value="{{$data->TRUSTEEFEE_RULE_ID}}" name="trfid" required>
