			...
			<div class="row align-items-center">
				<div class="col-md-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href=" {{ url('/trading/torder/conf') }} ">Buy Confirmation Reports</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<h5>Buy Confirmation Reports</h5>
											...
											<div class="col-md-10 col-sm-10 offset-md-1">
												...
												<div class="report_border">
													<div class="report">
														...
														<p id="t_date"></p>
														<p id="brk_dtl"></p>
														<p class="text-center subs_p">Trade Order Details</p>
	...
	$(document).ready(function(){
  		$("#sub_btn").on('click',function(){
    		...
    		if(trdt === ''){
    			...
    			$.ajax({
			        url: '/trading/torderconfbybrokId/'+brk_id+'/'+trdt,
			        type: "GET",
			        data : {"_token":"{{ csrf_token() }}"},
			        success:function(data) {
			        	var el = document.getElementById("table_part");
			            el.style.display = "block";
			            document.getElementById("t_date").innerHTML = 'Trade Date: ' + ntd;
