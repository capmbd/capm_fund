				...
				<div class="col-md-12">
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href=" {{ url('/trading/sellorder') }} ">
								<i class="feather icon-menu"></i>
							</a>
						</li>
						<li class="breadcrumb-item"><a href=" {{ url('/trading/sellorder') }} ">Sell Order</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-12 col-xl-5">
							<div class="card">
								...
								<div class="card-block">
									<form id="torder_form" action=" {{ url('/trading/soder/save') }} " method="post">
      										...
      										@foreach($pend_order as $pending)
      											<tr>
        											...
        											<td class="text-center">
														<a id="conf" href="{{ url('/trading/pending/sell/'.$pending->SELLORDER_ID) }}"  title="Confirm"><i class="fas fa-check-square text-success"></i></a> 
                                                        <a id="del" href="{{ url('/trading/delete/sell/'.$pending->SELLORDER_ID) }}"  title="Delete"><i class="fas fa-window-close text-danger"></i></a>
        											</td>
      											</tr>
      										@endforeach
    										</tbody>
