				...
				<div class="col-md-12">
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href=" {{ url('/corporate-action/dividend') }} ">
								<i class="feather icon-link"></i>
							</a>
						</li>
						<li class="breadcrumb-item"><a href=" {{ url('/corporate-action/dividend') }} ">Dividend Setup</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<h5>Dividend Setup</h5>
									<p class="text-success insert_message"> <b> {{ Session::get('message') }} </b> </p>
								</div>
								<div class="card-block">
									<form id="dividend_form" action=" {{ url('/corporate-action/dividend/save') }} " method="post">
										@csrf
										<div class="row">
											<div class="col-md-6 col-sm-6">
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="DIVIDEND" class="form-control autonumber" placeholder="%">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="INDV_ETIN_TAX" class="form-control autonumber"   placeholder="% (With E-TIN)">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="INDV_TAX" class="form-control autonumber"   placeholder="% (Without E-TIN)">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="INST_INC_TAX" class="form-control autonumber"  placeholder="%">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="TAX_MARGIN" class="form-control autonumber">
													</div>
												</div>
											</div>
											...
											<div class="col-md-6 col-sm-6">
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="NET_PROFIT" class="form-control autonumber">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="EARNINGS_PER_UNIT" class="form-control autonumber">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="BUY_PRICE" class="form-control autonumber">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="date" name="APRV_DATE" class="form-control autonumber">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="date" name="YED" class="form-control autonumber">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="date" name="TC_DATE" class="form-control autonumber">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="date" name="TCIP_DATE" class="form-control autonumber">
													</div>
												</div>
