...
<body>
	<div class="main">
		<div class="main_one">
			...
			<img class="qr_img" src="{{public_path('qr_code/buy_conf/'.$qr_code_name.'.png')}}" alt="QR Code">
		</div>
	</div>
</body>
</html>