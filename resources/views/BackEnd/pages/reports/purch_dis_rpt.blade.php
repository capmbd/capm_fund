...
@section('title')
    Disapproved Fund Unit Purchase Applications
@endsection
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href=" {{ url('subscription-redumption/purchdisap') }} ">
                                <i class="feather icon-pie-chart"></i>
                            </a>
                        </li>
                        <li class="breadcrumb-item"><a href="  {{ url('subscription-redumption/purchdisap') }}">Disapproved Fund Unit Purchase Applications</a></li>
                    </ul>
                            ...
                            <table style="display: none;" id="indv_export_{{$indv_disapp[0]->PRO_REG_ID}}">
                                ...
                                @foreach($indv_disapp as $ind_dis)
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                $dadate = strtotime($ind_dis->HOUSE_CNF_REC_DATE);
                            ...
                            <table style="display: none;" id="inst_export_{{$inst_disapp[0]->PRO_REG_ID}}">
                                ...
                                @foreach($inst_disapp as $ins_dis)
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                $dadate = strtotime($ins_dis->HOUSE_CNF_REC_DATE);
                                                $dandate = date('F d, Y', $dadate);
                                            ?>
                                            {{$dandate}}
                                        </td>
        ...
        $(document).ready(function() {
            $('#indv_export_1').DataTable( {
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Disapproved Fund Unit Purchase Applications ( Individual "CAPM Unit Fund" )',
                        filename: 'Purchase_Disapprove_Report',
                        messageTop: gettime()
                    },
                    {
                        extend: 'csvHtml5',
        ...
        $(document).ready(function() {
            $('#indv_export_2').DataTable( {
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Disapproved Fund Unit Purchase Applications ( Individual "Test Unit Fund" )',
                        filename: 'Purchase_Disapprove_Report',
                        messageTop: gettime()
                    },
                    {
        ...
        $(document).ready(function() {
            $('#inst_export_1').DataTable( {
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Disapproved Fund Unit Purchase Applications ( Institutional "CAPM Unit Fund" )',
                        filename: 'Purchase_Disapprove_Report',
                        messageTop: gettime()
                    },
                    {
        ...
        $(document).ready(function() {
            $('#inst_export_2').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Disapproved Fund Unit Purchase Applications ( Institutional "Test Unit Fund" )',
                        filename: 'Purchase_Disapprove_Report',
                        messageTop: gettime()
                    },
                    {
