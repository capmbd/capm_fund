				...
				<div class="col-md-12">
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href=" {{ url('/subscription-redumption/surrender_report') }} ">
								<i class="feather icon-pie-chart"></i>
							</a>
						</li>
						<li class="breadcrumb-item"><a href=" {{ url('/subscription-redumption/surrender_report') }} ">Surrender Report</a></li>
					</ul>
				</div>
			</div>
		</div>
											...
											<div class="col-md-10 col-sm-10 offset-md-1">
												<div id="printDiv">
													<div class="report">
														...
														<p class="text-center subs_p">Surrender Report</p>
														<p id="fndnm"></p>
														<p id="frmto"></p>
							                            <table id="subs_table">
							                                <thead>
	...
	$(document).ready(function(){
  			$("#sub_btn").on('click',function(){
    			...
    			if(fid === ''){
    				...
    				$.ajax({
			            url: '/subscription-redumption/surreport/'+rid+'/'+fid+'/'+fdate+'/'+tdate,
			            type: "GET",
