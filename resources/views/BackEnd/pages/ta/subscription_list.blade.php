				...
				<div class="col-md-12">
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href=" {{ url('/ta/unit_sub_list') }} ">
								<i class="feather icon-info"></i>
							</a>
						</li>
						<li class="breadcrumb-item"><a href=" {{ url('/ta/unit_sub_list') }} ">Subscription List</a></li>
					</ul>
											...
											<div class="tab-content tabs card-block">
												<div class="tab-pane active" id="app" role="tabpanel">
													...
													<div class="table-responsive">
														<table id="sub_app_{{$appr[0]->PRO_REG_ID}}" class="table table-bordered tbl_dta">
				    										<thead>
				      											<tr>
				    										...
				    										<tbody>
				    											@foreach($appr as $app)
				      											<tr>
				      												...
				      												<td>{{$app->PURCHASE_PERSON_ID}}{{$app->PURCHASE_NO}}</td>
																	<?php
																		$date = $app->created_at;
												...
												<div class="tab-pane" id="dis" role="tabpanel">
													...
													<div class="table-responsive">
														<table id="sub_dis_{{$disappr[0]->PRO_REG_ID}}" class="table table-bordered tbl_dta">
				    										<thead>
				      											<tr>
				        											<th>Registration No.</th>
				        											<th>Unit</th>
				    										...
				    										<tbody>
				    											@foreach($disappr as $disap)
				      											<tr>
				      												...
				      												<td>{{$disap->PURCHASE_PERSON_ID}}{{$disap->PURCHASE_NO}}</td>
																	<?php
												...
												<div class="tab-pane" id="pand" role="tabpanel">
													...
													<div class="table-responsive">
														<table id="sub_pen_{{$pend[0]->PRO_REG_ID}}" class="table table-bordered tbl_dta">
				    										<thead>
				      											<tr>
				        											<th>Registration No.</th>
				        											<th>Unit</th>
				    										...
				    										<tbody>
				    											@foreach($pend as $pen)
				      											<tr>
				      												...
				      												<td>{{$pen->PURCHASE_PERSON_ID}}{{$pen->PURCHASE_NO}}</td>
																	<?php
																		$date = $pen->created_at;
																		$ndate = date("d-M-Y", strtotime($date));
																	?>
