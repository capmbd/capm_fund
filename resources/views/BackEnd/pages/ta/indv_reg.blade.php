	...
	<div class="page-header">
		<div class="page-block">
			<div class="row align-items-center">
				<div class="col-md-12">
				<form class="form-inline" action="{{ url('/ta/indv/excel_import') }}" method="post" enctype="multipart/form-data">
				@csrf
						  <div class="form-group">
							<label style="font-weight:bold;" for="file">Import Excel file :</label>
										...
										<div class="row">
											<div class="col-md-12 col-sm-12">
												<p class="div_text">Principal Applicant's Details
													<span>
														...
														<input type="radio" value="Mrs." name="GENDER" {{ $data['gender'] == 'Ms.' ? 'checked' : '' }} >Mrs.
														<input type="radio" value="Ms." name="GENDER" {{ $data['gender'] == 'Other' ? 'checked' : '' }} >Other
													</span>
												</p>
											</div>
											<div class="col-md-7 col-sm-7">
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="NAME" class="form-control autonumber" value="{{$data['app_name']}}" >
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="FATHER_NAME" class="form-control autonumber" value="{{$data['f_name']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="MOTHER_NAME" class="form-control autonumber" value="{{$data['m_name']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<textarea class="form-control autonumber" name="PERMANENT_ADDRESS" rows="3">{{$data['permanent_address']}}</textarea>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="NATIONAL_ID" class="form-control autonumber" value="{{$data['NID_PID']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="CITY" class="form-control autonumber" value="{{$data['city']}}">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="DISTRICT" class="form-control autonumber" value="{{$data['District']}}">
													</div>
												</div>
												...
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="file" id="NID_IMG" name="NID_IMG" value="{{$data['District']}}">
													</div>
												</div>
											...
											<div class="col-md-5 col-sm-5">
												<div class="row form-group">
													...
													<div class="col-sm-7">
														<select name="COUNTRY" class="col-sm-12 form-select">
															<option value="{{$data['C_code']}}">{{$data['Country_of_Resi']}}</option>
												...
												<div class="row form-group">
													...
													<div class="col-sm-7">
														<input type="date" name="BIRTHDAY" class="form-control autonumber" value="{{$data['Birth_Date']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="TELEPHONE" class="form-control autonumber" value="{{$data['contact']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="EMAIL" class="form-control autonumber" value="{{$data['email']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="NATIONALITY" class="form-control autonumber" value="{{$data['nationality']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="BOID" class="form-control autonumber" value="{{$data['BO_ID']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="POST_CODE" class="form-control autonumber" value="{{$data['post_code']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="OCCUPATION" class="form-control autonumber" value="{{$data['Occupation']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="ETIN" class="form-control autonumber" value="{{$data['e_tin']}}">
													</div>
												</div>
											</div>
											...
											<div class="col-md-7 col-sm-7">
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="ACCOUNT_NAME" class="form-control autonumber" value="{{$data['Account_Name']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="number" name="ACCOUNT_NO" class="form-control autonumber" value="{{$data['bank_ac_no']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="BANK_NAME" class="form-control autonumber" value="{{$data['bank_name']}}">
													</div>
												</div>
											</div>
											...
											<div class="col-md-5 col-sm-5">
												<div class="row form-group">
													...
													<div class="col-sm-7">
														<input type="text" name="ROUTING_NO" class="form-control autonumber" value="{{$data['rounting_no']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="BRANCH" class="form-control autonumber" value="{{$data['branch_name']}}">
													</div>
												</div>
											</div>
											...
											<div class="col-md-12 col-sm-12">
												<p class="div_text">Preferred Dividend Option
													<span>
														<input type="radio" value="CIP" name="DIVIDENT_OPT" {{ $data['Dividend_type'] == 'Cumulative Investment Plan (CIP)' ? 'checked' : '' }} >Cumulative Investment Plan (CIP)
														<input type="radio" value="Cash" name="DIVIDENT_OPT" {{ $data['Dividend_type'] == 'Cash' ? 'checked' : '' }} >Cash
													</span>
												</p>
											</div>
											...
											<div class="col-md-7 col-sm-7">
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" id="input_text1" name="SECOND_APL_NAME" class="form-control autonumber" value="{{$data['s_app_name']}}" disabled>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" id="input_text2" name="SECOND_APL_FATHER" class="form-control autonumber" value="{{$data['s_f_name']}}" disabled>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" id="input_text3" name="SECOND_APL_MOTHER" class="form-control autonumber" value="{{$data['s_m_name']}}" disabled>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<textarea class="form-control autonumber" name="SECOND_APL_PRES" id="input_text4" rows="3" disabled>{{$data['s_present_address']}}</textarea>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<textarea class="form-control autonumber" name="SECOND_APL_PER" id="input_text5" rows="3" disabled>{{$data['s_permanent_address']}}</textarea>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="number" id="input_text6" name="SECOND_APL_NID" class="form-control autonumber" value="{{$data['s_nid_pid']}}" disabled>
													</div>
												</div>
											...
											<div class="col-md-5 col-sm-5">
												...
												<div class="row form-group">
													...
													<div class="col-sm-7">
														<input type="date" id="input_text7" name="SECOND_APL_DOB" class="form-control autonumber" value="{{$data['s_date_birth']}}" disabled>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="SECOND_APL_CONT" id="input_text8" class="form-control autonumber" value="{{$data['s_phone_no']}}" disabled>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" id="input_text9" name="SECOND_APL_NATION" class="form-control autonumber" value="{{$data['s_nationality']}}" disabled>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" id="input_text10" name="SECOND_APL_OCU" class="form-control autonumber" value="{{$data['s_occupation']}}" disabled>
													</div>
												</div>
											...
											<div class="col-md-7 col-sm-7">
												<div class="row form-group">
													...
													<div class="col-sm-8">
														<input type="text" name="NOMINEE_NAME" class="form-control autonumber" value="{{$data['nominee_name']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="NOMINEE_FATHER" class="form-control autonumber" value="{{$data['nominee_fname']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="NOMINEE_MOTHER" class="form-control autonumber" value="{{$data['nominee_mname']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="text" name="NOMINEE_RELATION" class="form-control autonumber" value="{{$data['nominee_relation']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<textarea class="form-control autonumber" name="NOMINEE_PRES_ADDRSS" rows="3">{{$data['nominee_present_address']}}</textarea>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<textarea class="form-control autonumber" name="NOMINEE_PER_ADDRESS" rows="3">{{$data['nominee_permanent_address']}}</textarea>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-4">
													...
													<div class="col-sm-8">
														<input type="number" name="NOMINEE_NID" class="form-control autonumber" value="{{$data['nominee_nid_pid']}}">
													</div>
												</div>
											...
											<div class="col-md-5 col-sm-5">
												...
												<div class="row form-group">
													...
													<div class="col-sm-7">
														<input type="date" name="NOMINEE_DOB" class="form-control autonumber" value="{{$data['nominee_date_birth']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<input type="text" name="NOMINEE_CONTACT" class="form-control autonumber" value="{{$data['nominee_contact']}}">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-sm-5">
													...
													<div class="col-sm-7">
														<select name="NOMINEE_COUNTRY" class="col-sm-12 form-select">
															<option value="{{$data['Issuing_C_code']}}">{{$data['Issuing_Country']}}</option>
															@foreach( $countries as $country )
															<option value="{{$country->APPLICANT_COUNTRY_CODE}}">{{$country->APPLICANT_COUNTRY_NAME}}</option>
															@endforeach
														</select>
												...
												<div class="row form-group">
													...
													<div class="col-sm-7">
														<input type="text" name="NOMINEE_OCCUPATION" class="form-control autonumber" value="{{$data['nominee_occupation']}}">
													</div>
												</div>
											</div>
