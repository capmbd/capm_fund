				...
				<div class="col-md-12">
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href=" {{ url('subscription-redumption/pending-purchase-manager') }} ">
								<i class="feather icon-pie-chart"></i>
							</a>
						</li>
						<li class="breadcrumb-item"><a href=" {{ url('subscription-redumption/pending-purchase-manager') }} ">Pending Purchase Unit Application</a></li>
					</ul>
      											...
      											<tr>
                                                    ...
                                                    <td>{{$pend->PORTFOLIO_NAME}}</td>
      												...
      												<td class="text-center">
														<a id="pend_ind" href="{{url('subscription-redumption/pending-purchase/approve/man/'.$pend->UNIT_PURCHASE_ID.'/'.$user_id)}}"  title="Approve"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a> 
                                                        <a id="pend_ind_dis" href="{{url('subscription-redumption/pending-purchase/disapprove/man/'.$pend->UNIT_PURCHASE_ID.'/'.$pend->REGISTRATION_NO.'/'.$pend->UNIT.'/'.$user_id)}}"  title="Disapprove"><i style="font-size: 20px" class="fas fa-window-close text-danger"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
    										...
    										<tbody>
      											...
      											<tr>
													...
													<td>
      												...
      												<td class="text-center">
														<a id="pend_ins" href="{{url('subscription-redumption/pending-purchase/approve/man/'.$pend_inst->UNIT_PURCHASE_ID.'/'.$user_id)}}"  title="Approve"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a> 
                                                        <a id="pend_ins_dis" href="{{url('subscription-redumption/pending-purchase/disapprove/man/'.$pend_inst->UNIT_PURCHASE_ID.'/'.$pend_inst->REGISTRATION_NO.'/'.$pend_inst->UNIT.'/'.$user_id)}}"  title="Disapprove"><i style="font-size: 20px" class="fas fa-window-close text-danger"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
