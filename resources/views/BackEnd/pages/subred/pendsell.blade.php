			...
			<div class="row align-items-center">
				<div class="col-md-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href=" {{ url('subscription-redumption/pending-sell') }} ">Pending Sell Unit Application</a></li>
					</ul>
      											...
      											<tr>
                                                    ...
                                                    <td>{{$pend->PORTFOLIO_NAME}}</td>
      												...
      												<td class="text-center">
														<a id="pend_ind" href="{{url('subscription-redumption/pending-sell/approve/'.$pend->UNIT_SELL_ID.'/'.$user_id)}}" data-toggle="tooltip" title="Approve"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
										...
										<table class="table table-bordered tbl_dta" style="border-top: 1px solid #dee2e6;">
    										...
    										<tbody>
      											...
      											<tr>
													...
													<td>{{$pend_inst->MODE_PAY}}</td>
      												<td class="text-center">
														<a id="pend_ins" href="{{url('subscription-redumption/pending-sell/approve/'.$pend_inst->UNIT_SELL_ID.'/'.$user_id)}}" data-toggle="tooltip" title="Approve"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
