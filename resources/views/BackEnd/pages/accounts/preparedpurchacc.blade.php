			...
			<div class="row align-items-center">
				<div class="col-md-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#">Unit Purchase Receipt</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-12 col-xl-6">
							<div class="card">
								...
								<div class="card-block">
									<form id="bank_form" action=" {{ url('portfolio-accounts/pending-purchase/approve/acc') }} " method="post">

										@csrf

										<input type="hidden" value="{{$user_id}}" name="user_id" required>
										<input type="hidden" value="{{$PURCHASE_PANDING_UNIT->UNIT_PURCHASE_ID}}" name="UNIT_PURCHASE_ID" required>
										<div class="row form-group">
											<div class="col-sm-4">
									   <label class="col-form-label">Registration No</label>
											</div>
											<div class="col-sm-8">
												<input type="text" value="{{$PURCHASE_PANDING_UNIT->REGISTRATION_NO}}" name="REGISTRATION_NO" class="form-control autonumber" readonly>
											</div>
										</div>
										<div class="row form-group">
											<div class="col-sm-4">
											...
											<div class="col-sm-8">
												<input type="text" value="{{$PURCHASE_PANDING_UNIT->TOTAL_AMOUNT}}" name="TOTAL_AMOUNT" class="form-control autonumber" readonly>
											</div>
										</div>
										...
										<div class="row form-group">
											...
											<div class="col-sm-8">
												<button type="submit" id="submitbtn" class="btn btn-primary m-b-0">Receipt Clear</button>
											</div>
										</div>
