				...
				<div class="col-md-12">
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href=" {{ url('/portfolio-accounts/pending-purchase-accounts') }} ">
								<i class="feather icon-credit-card"></i>
							</a>
						</li>
						<li class="breadcrumb-item"><a href=" {{ url('/portfolio-accounts/pending-purchase-accounts') }} ">Pending Sell Unit Application</a></li>
					</ul>
    										...
    										<tbody>
      											...
      											<tr>
                                                    ...
                                                    <td>{{$pend->PORTFOLIO_NAME}}</td>
      												...
      												<td>{{$pend->MODE_PAY}}</td>
                                                    <?php
                                                        $usid = encrypt($pend->UNIT_SELL_ID);
                                                    ?>
      												<td class="text-center">
														<a id="pend_ind" href="{{url('/portfolio-accounts/pending-sell/prepared/acc/'.$usid.'/'.$user_id)}}" data-toggle="tooltip" title="Payment"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
										...
										<table class="table table-bordered tbl_dta" style="border-top: 1px solid #dee2e6;">
    										...
    										<tbody>
      											...
      											<tr>
                                                    ...
                                                    <?php
                                                        $sins = encrypt($pend_inst->UNIT_SELL_ID);
                                                    ?>
      												<td class="text-center">
														<a id="pend_ins" href="{{url('/portfolio-accounts/pending-sell/prepared/acc/'.$sins.'/'.$user_id)}}" data-toggle="tooltip" title="Payment"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
