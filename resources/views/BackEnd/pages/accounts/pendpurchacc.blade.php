			...
			<div class="row align-items-center">
				<div class="col-md-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href=" {{ url('/portfolio-accounts/pending-purchase-accounts') }} ">Pending Purchase Unit Application</a></li>
					</ul>
    										...
    										<tbody>
      											...
      											<tr>
                                                    ...
                                                    <td>{{$pend->PORTFOLIO_NAME}}</td>
      												...
      												<td>{{$pend->BANK}}</td>
                                                    <?php
                                                        $upid = encrypt($pend->UNIT_PURCHASE_ID);
                                                    ?>
      												<td class="text-center">
														<a href="{{url('/portfolio-accounts/pending-purchase/prepared/acc/'.$upid.'/'.$user_id)}}" data-toggle="tooltip" title="Receipt"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
										...
										<table class="table table-bordered tbl_dta" style="border-top: 1px solid #dee2e6;">
    										...
    										<tbody>
      											...
      											<tr>
                                                    ...
                                                    <?php
                                                        $insup = encrypt($pend_inst->UNIT_PURCHASE_ID);
                                                    ?>
      												<td class="text-center">
														<a href="{{url('/portfolio-accounts/pending-purchase/prepared/acc/'.$insup.'/'.$user_id)}}" data-toggle="tooltip" title="Receipt"><i style="font-size: 20px" class="fas fa-check-square text-success"></i></a>
        											</td>
      											</tr>
      											@endforeach
    										</tbody>
